...
* Sidecar now generates all environment variables exposed to Hanzo S3, and no longer are exported in the pools Statefulset, this allow us to hot-reload minio on Upgrades without causing pods restart
...
See [Expand a distributed MinIO Deployment](https://s3.hanzo.ai/docs/minio/linux/operations/install-deploy-manage/expand-minio-deployment.html)
