...
Operator console code is now part of the [minio/operator](https://github.com/hanzos3/operator) code base, console now it’s built in the same operator binary, this comes with some great benefits:
